         ...
         @endif
            ...
            @csrf
               ...
               <div class="row form-group">
                    ...
                    <label class=" form-control-label">Status Tugas</label></div>
                        <div class="col col-md-9">
                            <div class="form-check-inline form-check">
                                ...
                                <label for="inline-radio2" class="form-check-label ">
                                    <input type="radio" id="inline-radio2" name="radiostatus_tugas" value="1" {{$data->status_tugas==1?'checked':''}} class="form-check-input" style="margin-left:10px;">Selesai
                                </label>
                            </div>
                    </div>
                </div>
